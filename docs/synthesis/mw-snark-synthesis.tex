...
The local development adds a new synthesis example file.  It contributes seven
entry points:
\begin{lstlisting}
...
symbols.  SNARK has proved that a witness with this shape exists under the
stated obligations; it has not, by itself, supplied concrete Common Lisp
definitions for those abstract symbols.
